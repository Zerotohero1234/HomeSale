            ...
            <div class="row mt-3">
                <div class="col-md-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <form method="POST" enctype="multipart/form-data" action="/addFutureWorkImage">
                                @csrf
                                <input type="hidden" name="futurework_id" value="{{ $id }}">
                                <div class="row">
                                    <div class="col-md-4">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        @foreach ($futureWorkImages as $futureWorkImage)
                                            <tr>
                                                <td class="w-50">
                                                    <img src="/img/design/slide/{{ $futureWorkImage->img_src }}"
                                                        alt="..." class="img-fluid img-thumbnail">
                                                </td>
                                                <td>
                                                    <a class="pl-5"
                                                        href="/deleteFutureWorkImage/{{ $futureWorkImage->id }}/futurework_id/{{ $id }}">
                                                        <i class="material-icons">delete</i>
                                                    </a>
                                                </td>
                                                {{-- <td>
                                                    <a href="/deletePlan/{{ $futureWorkImage->id }}">
                                                        {{ $futureWorkImage->enabled == '1' ? 'ປິດໃຊ້ງານ' : 'ເປີດໃຊ້ງານ' }}
                                                    </a>
                                                </td> --}}
                                            </tr>
                                        @endforeach
