            ...
            <div class="row mt-3">
                <div class="col-md-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <form method="POST" enctype="multipart/form-data" action="/addTopSellingSlideImage">
                                @csrf
                                <div class="row">
                                    <div class="col-md-4">
                        ...
                        <div class="x_content">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        @foreach ($topSellingSlideImages as $topSellingSlideImage)
                                            <tr>
                                                <td class="w-50">
                                                ...
                                                <td>
                                                    <a class="pl-5"
                                                        href="/deleteTopSellingSlideImage/{{ $topSellingSlideImage->id }}">
                                                        <i class="material-icons">delete</i>
                                                    </a>
                                                </td>
                                                {{-- <td>
                                                    <a href="/deletePlan/{{ $topSellingSlideImage->id }}">
                                                        {{ $topSellingSlideImage->enabled == '1' ? 'ປິດໃຊ້ງານ' : 'ເປີດໃຊ້ງານ' }}
                                                    </a>
                                                </td> --}}
                                            </tr>
                                        @endforeach
