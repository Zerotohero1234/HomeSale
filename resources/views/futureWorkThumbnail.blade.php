        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    ...
                    <h3 class="d-inline pl-3">ແກ້ໄຂໜ້າປົກຜົນງານທີ່ຜ່ານມາ</h3>
                </div>
            </div>
            ...
            <div class="row mt-3">
                <div class="col-md-12">
                    <div class="x_panel">
                        <div>
                            <h2 class="card-title">ແກ້ໄຂໜ້າປົກຜົນງານທີ່ຜ່ານມາ</h2>
                        </div>
                        <div class="x_content">
                            <form method="POST" enctype="multipart/form-data" action="/updateFutureWorkThumbnail">
                                @csrf
                                <input type="hidden" name="id" value="{{ $futureWork->id }}">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="bmd-label-floating">ຊື່</label>
                                            <img src="/img/design/{{ $futureWork->thumbnail }}" alt="..."
                                                id="thumbnail-img" class="img-thumbnail">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
