            ...
            <div class="row mt-3">
                <div class="col-md-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <form method="POST" enctype="multipart/form-data" action="/addPresentWorkImage">
                                @csrf
                                <input type="hidden" name="presentwork_id" value="{{ $id }}">
                                <div class="row">
                                    <div class="col-md-4">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        @foreach ($presentWorkImages as $presentWorkImage)
                                            <tr>
                                                <td class="w-50">
                                                    <img src="/img/design/slide/{{ $presentWorkImage->img_src }}"
                                                        alt="..." class="img-fluid img-thumbnail">
                                                </td>
                                                <td>
                                                    <a class="pl-5"
                                                        href="/deletePresentWorkImage/{{ $presentWorkImage->id }}/presentwork_id/{{ $id }}">
                                                        <i class="material-icons">delete</i>
                                                    </a>
                                                </td>
                                                {{-- <td>
                                                    <a href="/deletePlan/{{ $presentWorkImage->id }}">
                                                        {{ $presentWorkImage->enabled == '1' ? 'ປິດໃຊ້ງານ' : 'ເປີດໃຊ້ງານ' }}
                                                    </a>
                                                </td> --}}
                                            </tr>
                                        @endforeach
