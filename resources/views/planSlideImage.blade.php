        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="x_panel">
                        <div>
                            <h2 class="card-title">ແກ້ໄຂໜ້າປົກແບບເຮືອນ</h2>
                        </div>
                        <div class="x_content">
                            <form method="POST" enctype="multipart/form-data" action="/updatePlanSlideImage">
                                @csrf
                                <input type="hidden" name="id" value="{{ $planSlideImage->id }}">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="bmd-label-floating">ຊື່</label>
                                            <img src="/img/design/slide/{{ $planSlideImage->img_src }}" alt="..."
