        ...
        <div class="">
            ...
            <div class="row mt-3">
                <div class="col-md-12">
                    <div class="x_panel">
                        <div>
                            <h2 class="card-title">ເພີ່ມຮູບຜັງ</h2>
                        </div>
                        <div class="x_content">
                            <form method="POST" enctype="multipart/form-data" action="/addFloorPlanSlideImage">
                                @csrf
                        ...
                        <div class="x_content">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        @foreach ($floorPlanSlideImages as $floorPlanSlideImage)
                                            <tr>
                                                <td class="w-50">
                                                    <img src="/img/design/slide/{{ $floorPlanSlideImage->img_src }}"
                                                        alt="..." class="img-fluid img-thumbnail">
                                                </td>
                                                <td>
                                                    <a class="pl-5"
                                                        href="/deleteFloorPlanSlideImage/{{ $floorPlanSlideImage->id }}/plan/{{ $id }}">
                                                        <i class="material-icons">delete</i>
                                                    </a>
                                                </td>
                                                {{-- <td>
                                                    <a href="/deletePlan/{{ $floorPlanSlideImage->id }}">
                                                        {{ $floorPlanSlideImage->enabled == '1' ? 'ປິດໃຊ້ງານ' : 'ເປີດໃຊ້ງານ' }}
                                                    </a>
                                                </td> --}}
                                            </tr>
                                        @endforeach
