            ...
            <div class="row mt-3">
                <div class="col-md-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <form method="POST" enctype="multipart/form-data" action="/addHomeSlideImage">
                                @csrf
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="bmd-label-floating">ລິ້ງ</label>
                        ...
                        <div class="x_content">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        @foreach ($homeSlideImages as $homeSlideImage)
                                            <tr>
                                                <td class="w-50">
                                                    <img src="/img/design/slide/{{ $homeSlideImage->img_src }}"
                                                        alt="..." class="img-fluid img-thumbnail">
                                                </td>
                                                <td>
                                                    <a class="pl-5"
                                                        href="/deleteHomeSlideImage/{{ $homeSlideImage->id }}">
                                                        <i class="material-icons">delete</i>
                                                    </a>
                                                </td>
                                                {{-- <td>
                                                    <a href="/deletePlan/{{ $homeSlideImage->id }}">
                                                        {{ $homeSlideImage->enabled == '1' ? 'ປິດໃຊ້ງານ' : 'ເປີດໃຊ້ງານ' }}
                                                    </a>
                                                </td> --}}
                                            </tr>
                                        @endforeach
