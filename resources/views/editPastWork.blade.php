            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <form method="POST" action="/updatePastWork">
                                @csrf
                                <input type="hidden" name="id" value="{{ $pastWork->id }}">
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="bmd-label-floating">ຊື່</label>
                                            <input type="text" name="name" value="{{ $pastWork->name }}"
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="en_name" value="{{ $pastWork->en_name }}"
                                                class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="cn_name" value="{{ $pastWork->cn_name }}"
                                                class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="th_name" value="{{ $pastWork->th_name }}"
                                                class="form-control">
                                        </div>
                                    </div>
                                </div>
