            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <form method="POST" action="/updateFutureWork">
                                @csrf
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" value="{{ $futureWork->name }}"
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="en_name" value="{{ $futureWork->en_name }}"
                                                class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="cn_name" value="{{ $futureWork->cn_name }}"
                                                class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="th_name" value="{{ $futureWork->th_name }}"
                                                class="form-control">
                                        </div>
                                    </div>
                                </div>
